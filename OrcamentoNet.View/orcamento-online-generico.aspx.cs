...
{
    public partial class orcamento_online_generico : System.Web.UI.Page, ICadastroPedidoOrcamentoSimples2
    {
        ...
        public string Observacao
        {
            get
            {
                return "Descrição:" + uxtxtObservacao.Text + ";" + Environment.NewLine + Environment.NewLine
