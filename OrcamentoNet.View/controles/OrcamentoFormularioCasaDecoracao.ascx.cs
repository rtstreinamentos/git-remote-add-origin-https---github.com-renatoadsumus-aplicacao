...
{
    public partial class OrcamentoFormularioCasaDecoracao : System.Web.UI.UserControl, ICadastroPedidoOrcamentoSimples
    {
        ...
        public string Observacao
        {
            get
            {
                ...
                return htmlTipoPessoa + hmtlObservacao + "Bairro, região ou local: " + uxtxtAreaAtuacao.Text + Environment.NewLine + htmlLigacao + htmlVisitaTecnica;
