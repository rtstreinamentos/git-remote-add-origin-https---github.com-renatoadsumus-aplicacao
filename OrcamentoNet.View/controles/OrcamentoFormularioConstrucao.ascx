<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrcamentoFormularioConstrucao.ascx.cs"
    Inherits="OrcamentoNet.View.controles.OrcamentoFormularioConstrucao" %>
        ...
        <ul class="fl">
            <li>
                ...
                <asp:DropDownList ID="uxddlTipoImovel" runat="server">
                    <asp:ListItem Value="0">Selecionar</asp:ListItem>
                    <asp:ListItem>Apartamento padrão</asp:ListItem>
                    <asp:ListItem>Apartamento duplex</asp:ListItem>
                    ...
                    <asp:ListItem>Loja ou Comércio</asp:ListItem>
            ...
            <%--<div id='loading' style='display: none'><img src="http://www.paraibaagora.com/v2/imagens/loading-gif-animation.gif" title="Loading" /></div>--%>
            <li>
                <label>
