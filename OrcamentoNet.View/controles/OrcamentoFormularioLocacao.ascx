<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrcamentoFormularioLocacao.ascx.cs" Inherits="OrcamentoNet.View.controles.OrcamentoFormularioLocacao" %>
...
<fieldset>
        ...
        <ul class="fl">
            ...
            <li class="sugestoesOrcamentos">
                <asp:Repeater ID="uxrptCategorias" runat="server">
                    <HeaderTemplate>
                        <label>Que serviços deseja?</label>
                        &nbsp;<ul>
                    </HeaderTemplate>
                    <ItemTemplate>
    ...
    <div style="float: right; width: 49%;">
        <ul class="fl">
            <li>
                Quantos dias:<label>:</label>
                 <asp:TextBox CssClass="ie6SubmitFix" ID="uxtxtNumeroDias" runat="server" Width="30px" MaxLength="2"></asp:TextBox>
                <cc1:FilteredTextBoxExtender ID="FilteredTextBoxExtender4" runat="server" TargetControlID="uxtxtNumeroDias"
                    FilterType="Numbers">
                </cc1:FilteredTextBoxExtender>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="uxtxtNumeroDias"
                    ErrorMessage=""  Text="Número de dias para locação deve ser informado." />
            </li>
            <li>
                <label>
                    Bairro, região ou local:Bairro, região ou local:</label>
                <asp:TextBox ID="uxtxtLocalObra" runat="server" MaxLength="200" Width="256px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ControlToValidate="uxtxtLocalObra"
                    ErrorMessage="" Text="O local deve ser informado." InitialValue="0" /><br />
            </li>
            <%--<li>
                <label>
                    Operador:</label>
                <asp:DropDownList ID="uxddlMaterias" runat="server">
                    <asp:ListItem Value="0">Selecionar</asp:ListItem>
                    <asp:ListItem>Eu não preciso de operador</asp:ListItem>
                    <asp:ListItem>A empresa deve fornecer operador</asp:ListItem>
                </asp:DropDownList>
                <br />
            ...
            <li>
                ...
                <asp:TextBox CssClass="ie6SubmitFix" ID="uxtxtNome" runat="server" MaxLength="100"
                    Width="256" ToolTip="Informe seu nome."></asp:TextBox><br />
