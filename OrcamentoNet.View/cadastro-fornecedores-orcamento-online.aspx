<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cadastro-fornecedores-orcamento-online.aspx.cs"
    Inherits="OrcamentoNet.View.orcamento_online_parceiro_passo0" MasterPageFile="~/OrcamentoNet.Master" %>
...
+                    var js, fjs = d.getElementsByTagName(s)[0];
            ...
            <div class="fb-like" data-href="novo-fornecedore-passo1.aspx"
            ...
            <asp:MultiView ID="multiview" runat="server" ActiveViewIndex="0">
                <asp:View ID="viewPasso0" runat="server">
                    <p class='productDescription'>
                        Veja no vídeo abaixo como funciona o sistema:</p>
                    <p>
