...
{
    public class CadastroPedidoOrcamentoSimplesPresenter2
    {
        public ICadastroPedidoOrcamentoSimples2 View { get; set; }
        ...
        public void Salvar()
        {
            if (View.IdCidadePedidoOrcamento != 0 && View.SubCategorias.Count >= 0)
            {
                    ...
                    cidadePedidoOrcamento != null)
                {
                    ...
                    pedidoOrcamento.PessoaTipo = View.PessoaTipo;
        ...
        public void CarregarSubCategorias()
        {
            ...
            if (View.IdCategoriaRecebida > 0)
            {
                ...
                if (View.IdCidadeRecebida > 30)
                {
                    Cidade cidade = cidadeService.Obter(View.IdCidadeRecebida);

                    if (View.IdBairroRecebido > 0)
                        nomeCidade = cidade.Nome + " - " + cidade.Bairros.Where(x => x.Id == View.IdBairroRecebido).FirstOrDefault().Nome;
                    else
                        nomeCidade = cidade.Nome;
                }

                if (View.IdCidadeRecebida > 3 && View.IdCidadeRecebida < 30)
                {
