                ...
                foreach (int idEstado in idsEstados)
                {
                    ...
                    if (persona == Persona.Comprador)
                    {
                        ...
                        if ((DateTime.Now.Day / 2) == 0)
                            linkInternoEstadoCidade.UrlAmigavel = "orcamentos/" + Common.UtilString.GerarUrlParaSeo(categoria.Nome) + "/" + Common.UtilString.GerarUrlParaSeo(estado.Nome) + "/online-" + categoria.Id.ToString() + "-" + estado.Id.ToString() + ".aspx";
                        else
                ...
                if (categoria.Termo != null && categoria.Termo != "")
                {
                    ...
                    foreach (string termo in listaTermos)
                    {
                        ...
                        if (estado.Nome != null)
                        {
                            ...
                            linkInterno.UrlAmigavel = "orcamentos/" + Common.UtilString.GerarUrlParaSeo(categoria.UrlMappings) + "-" + UtilString.GerarUrlParaSeo(estado.Nome) + "-" + categoria.Id.ToString() + "-" + estado.Id + "/" + Common.UtilString.GerarUrlParaSeo(termoSemEspacosAoRedor) + ".aspx";
                        }

                        if (estado.Nome == null)
                        {
                            linkInterno.ToolTip = "Solicite orçamento online grátis de " + categoria.Nome + " para " + termoSemEspacosAoRedor + ".";
                            linkInterno.UrlAmigavel = "orcamentos/" + Common.UtilString.GerarUrlParaSeo(categoria.UrlMappings) + "-" + categoria.Id.ToString() + "/" + Common.UtilString.GerarUrlParaSeo(termoSemEspacosAoRedor) + ".aspx";
                        }
                        ...
                        if (cidade != null && bairro == null)
                        {
                            ...
                            linkInterno.UrlAmigavel = "orcamentos/" + UtilString.GerarUrlParaSeo(categoria.UrlMappings) + "-" + UtilString.GerarUrlParaSeo(cidade.Nome) + "-" + categoria.Id.ToString() + "-" + cidade.Id + "/" + Common.UtilString.GerarUrlParaSeo(termoSemEspacosAoRedor) + ".aspx";
                        }

                        if (bairro != null)
                        {
                            linkInterno.ToolTip = "Solicite orçamento online grátis de " + categoria.Nome + " - " + bairro.Nome + " para " + termoSemEspacosAoRedor + ".";
                            linkInterno.UrlAmigavel = "orcamentos/" + UtilString.GerarUrlParaSeo(categoria.UrlMappings) + "-" + UtilString.GerarUrlParaSeo(bairro.Nome) + "-" + UtilString.GerarUrlParaSeo(cidade.Nome) + "-" + categoria.Id.ToString() + "-" + bairro.Id + "-" + cidade.Id + "/" + Common.UtilString.GerarUrlParaSeo(termoSemEspacosAoRedor) + ".aspx";
                        }
