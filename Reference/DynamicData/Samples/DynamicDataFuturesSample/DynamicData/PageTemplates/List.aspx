<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="List.aspx.cs" Inherits="DynamicDataFuturesSample.List" %>
            ...
            <asp:AdvancedFilterRepeater id="AdvancedFilterRepeater" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td><asp:DelegatingFilter runat="server" ID="DynamicFilter" OnSelectionChanged="OnFilterSelectionChanged" />
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </table>
