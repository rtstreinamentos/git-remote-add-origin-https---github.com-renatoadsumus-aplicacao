...
namespace DynamicDataFuturesSample {
    public partial class ListDetails : System.Web.UI.Page {
        protected void Page_Init(object sender, EventArgs e) {
            ...
            DynamicDataFutures.DisablePartialRenderingForUpload(this, DetailsDataSource.GetTable());
            DynamicDataFutures.RegisterListDetailsDefaults(GridDataSource, DetailsView1);
        }
